...
import com.example.testchat.adapters.RecentConversationsAdapter;
import com.example.testchat.databinding.ActivityMainBinding;
import com.example.testchat.listeners.ConversionListener;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void updateToken(String token){
        ...
        documentReference.update(Constants.KEY_FCM_TOKEN, token)
                .addOnSuccessListener(unused -> showToast("Berhasil Login"));
    }
