...
import com.example.testchat.adapters.TouchHelper;
...
public class MainActivity2 extends AppCompatActivity implements OnDialogCloseListner {
    ...
    public void buka_kembali(View view){
    Intent intent = new Intent(MainActivity2.this, ChatActivity.class); startActivity(intent);
    }
