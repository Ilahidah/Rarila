...
import com.example.testchat.listeners.OnDialogCloseListner;
...
public class AddNewTask extends BottomSheetDialogFragment{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        speechBtn = view.findViewById(R.id.speech_mic_btn);
        ...
        mTaskEdit.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.toString().equals("")){
                    mSaveBtn.setEnabled(false);
                    mSaveBtn.setBackgroundColor(Color.BLACK);
                }else {
        ...
        mSaveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (finalIsUpdate){
                    ...
                    Toast.makeText(context, "Task diperbarui", Toast.LENGTH_SHORT).show();
                }else {
                    if (task.isEmpty()) {
                        ...
                        firestore.collection("task").add(taskMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                            ...
                            public void onComplete(@NonNull Task<DocumentReference> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(context, "Task Tersimpan", Toast.LENGTH_SHORT).show();
                                } else {
